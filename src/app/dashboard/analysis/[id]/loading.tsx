        ...
        <section className="space-y-6">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-2">
                <div className="h-6 w-40 rounded-lg bg-slate-200/70" />
                <div className="h-4 w-56 rounded bg-slate-100" />
              </div>
            </div>
            <div className="space-y-1 text-right">
              <div className="h-3 w-16 rounded bg-slate-100 ml-auto" />
              <div className="h-10 w-16 rounded-lg bg-slate-200/70 ml-auto" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {Array.from({ length: 4 }).map((_, i) => (
              ...
              >
                <div className="h-3 w-16 rounded bg-slate-200/50 mx-auto" />
                <div className="h-8 w-12 rounded-lg bg-slate-200/70 mx-auto" />
                <div className="h-3 w-24 rounded bg-slate-100 mx-auto" />
              </div>
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="rounded-xl border border-slate-100 bg-slate-50/60 p-5">
              <div className="h-3 w-24 rounded bg-slate-200/50 mb-4" />
              <div className="mx-auto h-48 w-48 rounded-full bg-slate-100" />
            </div>
            <div className="rounded-xl border border-slate-100 bg-slate-50/60 p-5">
              <div className="h-3 w-28 rounded bg-slate-200/50 mb-4" />
            ...
            <div className="rounded-xl border border-slate-100 bg-slate-50/60 p-6">
              <div className="space-y-3">
                {Array.from({ length: 4 }).map((_, j) => (
                  <div key={j} className="h-4 rounded bg-slate-100" style={{ width: `${85 - j * 12}%` }} />
                ))}
              </div>
            </div>
          </section>
