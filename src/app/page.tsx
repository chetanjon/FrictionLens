    ...
    <div className="min-h-screen bg-black font-sans text-white relative overflow-hidden">
      ...
      <section id="main-content" className="relative z-10 mx-auto max-w-6xl px-6 pt-28 pb-20 lg:pt-32" aria-labelledby="hero-heading">
        <div className="max-w-2xl">
          {/* Badge */}
          <div className="hero-fade mb-8 inline-flex items-center gap-2.5 rounded-full border border-white/[0.10] bg-[#161616] px-4 py-2 text-sm text-slate-200">
          ...
          <h1 id="hero-heading" className="hero-fade-1 text-[clamp(2.5rem,6vw,4.5rem)] leading-[1.05] tracking-tight">
            <span className="font-light text-slate-200">Stop reading</span>
            <br />
            <span className="font-serif italic gradient-text">app reviews.</span>
            <br />
            <span className="font-bold text-white">Start acting on them.</span>
          </h1>

          {/* Subtitle */}
          <p className="hero-fade-2 mt-6 max-w-xl text-lg leading-relaxed text-slate-400">
            FrictionLens synthesizes hundreds of app store reviews into one
            shareable <span className="font-medium text-white">Vibe Report</span> &mdash;
          ...
          <div className="hero-fade-3 mt-10 flex max-w-lg items-center gap-0 rounded-2xl border border-white/[0.10] bg-[#111111] p-1.5 shadow-[0_0_30px_rgba(74,144,217,0.12),0_0_80px_rgba(74,144,217,0.05)]">
            <div className="flex items-center flex-1 min-w-0">
              ...
              <input
                ...
                className="min-w-0 flex-1 bg-transparent py-3 text-sm text-slate-200 placeholder:text-slate-500 outline-none"
              />
            </div>
            <Link
              href={ctaHref}
              className="shimmer-btn shrink-0 rounded-xl bg-friction-blue px-6 py-3 text-sm font-semibold text-white hover:bg-friction-blue/90 transition-colors"
            >
          ...
          {/* Stats */}
          <div className="hero-fade-4 mt-12 flex flex-wrap items-center gap-x-8 gap-y-3 text-sm text-slate-500">
            <div className="flex items-center gap-2">
              <span className="font-mono text-base font-semibold text-white">200</span>
              reviews per report
            </div>
            <div className="hidden sm:block h-4 w-px bg-white/[0.12]" />
            <div className="flex items-center gap-2">
              <span className="font-mono text-base font-semibold text-white">&lt; 60s</span>
              per report
            </div>
            <div className="hidden sm:block h-4 w-px bg-white/[0.12]" />
            <div className="flex items-center gap-2">
              <span className="font-mono text-base font-semibold text-white">$0</span>
              to start
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 mx-auto max-w-5xl px-6 pb-16">
        <AnimateOnScroll>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-xs text-slate-500">
            <span className="font-medium uppercase tracking-widest text-slate-500 font-mono">
              Built for teams at
            </span>
            {["Product Managers", "Growth Teams", "Mobile Devs", "CX Leaders"].map((role) => (
              <span
                key={role}
                className="rounded-full border border-white/[0.10] bg-[#111111] px-3 py-1 text-slate-300 backdrop-blur-xl"
              >
                {role}
              </span>
            ))}
      ...
      <section id="demo" className="relative z-10 mx-auto max-w-5xl px-6 pb-28">
        <AnimateOnScroll>
          <div className="rounded-2xl border border-white/[0.10] bg-white/[0.05] p-1 shadow-2xl shadow-black/30 backdrop-blur-xl">
            {/* Browser chrome */}
            <div className="flex items-center gap-3 rounded-t-xl bg-[#161616] px-4 py-3 border-b border-white/[0.08]">
              <div className="flex gap-1.5">
                <div className="h-3 w-3 rounded-full bg-[#FF5F57]" />
                <div className="h-3 w-3 rounded-full bg-[#FFBD2E]" />
                <div className="h-3 w-3 rounded-full bg-[#28C840]" />
              </div>
              <div className="flex-1 rounded-md bg-[#111111] border border-white/[0.08] px-3 py-1.5 text-xs text-slate-500 font-mono">
            ...
            <div className="p-4 sm:p-6 md:p-8 space-y-6">
              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold text-white">Spotify</h3>
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={item.label} className="flex items-center gap-3">
                        <div className="w-20 sm:w-24 text-xs text-slate-400 text-right shrink-0 truncate font-mono">
                          {item.label}
                        </div>
                        <div className="flex-1 h-[3px] rounded-full bg-[#1C1C1C] overflow-hidden">
                          <div
                            className={`h-full rounded-full ${item.color} transition-all`}
                            style={{ width: `${(item.score / 10) * 100}%` }}
                          />
                        </div>
                        <div className="font-mono text-xs font-bold text-slate-300 w-8 text-right">
                          {item.score}
                        </div>
                      </div>
                    ))}
              ...
              <div className="rounded-xl border border-friction-red/20 bg-friction-red/[0.04] px-4 sm:px-5 py-4 flex items-center gap-4 flex-wrap">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-slate-500 mt-0.5">342 mentions &middot; Critical severity</div>
                </div>
                <span className="pulse-glow inline-flex items-center rounded-md bg-friction-red px-2.5 py-1 text-[10px] font-bold text-white uppercase tracking-wide font-mono">
                  P0
                </span>
              </div>
            </div>
        ...
        <AnimateOnScroll>
          <div className="mb-16">
            ...
            <h2 className="text-3xl md:text-[46px] md:leading-[1.1] font-bold tracking-tight text-white max-w-lg">
              <span className="font-light text-slate-200">The report your team</span>
              <br />
          ...
          {([
            ...
            <AnimateOnScroll key={feature.num} delay={i * 100}>
              <div className="gradient-border-hover group h-full rounded-2xl border border-white/[0.07] bg-white/[0.03] backdrop-blur-md p-6 hover:bg-[#161616] hover:shadow-xl hover:shadow-black/20 hover:-translate-y-0.5 transition-all duration-200">
                ...
                <p className="text-[13.5px] leading-relaxed text-slate-400">{feature.desc}</p>
              </div>
            </AnimateOnScroll>
          ))}
        </div>
      ...
      <section className="relative z-10 mx-auto max-w-4xl px-6 pb-28">
        <AnimateOnScroll>
          <div className="text-center mb-16">
            <div className="font-mono text-[11px] font-semibold uppercase tracking-[3px] text-slate-500 mb-3">
              Process
            </div>
            <h2 className="text-3xl md:text-[42px] font-bold tracking-tight text-white">
          ...
          {[
            ...
            <AnimateOnScroll key={s.step} delay={i * 120}>
              <div className="text-center relative">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-white/[0.10] bg-[#161616] mb-5">
                  <span className="font-mono text-xl font-bold text-friction-blue">
                    {s.step}
                  </span>
                </div>
                <h3 className="text-lg font-bold text-white mb-2">{s.title}</h3>
                <p className="text-[13.5px] text-slate-400 leading-relaxed max-w-[240px] mx-auto">
                  {s.desc}
                </p>
              </div>
            </AnimateOnScroll>
      ...
      <section id="pricing" className="relative z-10 mx-auto max-w-5xl px-6 pb-28">
        <AnimateOnScroll>
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-[42px] font-bold tracking-tight text-white">
              <span className="font-light text-slate-200">Completely</span>{" "}
        ...
        <div className="grid md:grid-cols-2 gap-5 max-w-3xl mx-auto">
            ...
            <div className="relative rounded-2xl border border-white/[0.07] bg-white/[0.03] backdrop-blur-md p-7 flex flex-col h-full">
              <div className="mb-5">
                ...
                <div className="mt-3 flex items-baseline gap-1">
                  <span className="font-mono text-[40px] font-bold tracking-tight text-white">2</span>
                  <span className="text-sm text-slate-500">free analyses</span>
                </div>
              </div>
          ...
          <AnimateOnScroll delay={100}>
            <div className="relative rounded-2xl border border-friction-blue/30 bg-[#161616] p-7 flex flex-col h-full shadow-[0_0_40px_rgba(74,144,217,0.12),0_0_80px_rgba(74,144,217,0.05)] scale-[1.02]">
              ...
              <div className="mb-5">
                <h3 className="text-sm font-medium text-slate-400">Bring Your Key</h3>
                <div className="mt-3 flex items-baseline gap-1">
                  <span className="font-mono text-[40px] font-bold tracking-tight text-white">$0</span>
              ...
              <Link
                href={ctaHref}
                className="block w-full rounded-xl py-3 text-center text-sm font-semibold transition-colors border border-white/[0.10] bg-[#1C1C1C] text-white hover:bg-[#2A3040]"
              >
        ...
        <AnimateOnScroll>
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0A0A0A] via-[#111111] to-[#0A0A0A] px-8 py-20 text-center md:px-16 border border-white/[0.06] shadow-[0_0_80px_rgba(74,144,217,0.08)]">
            ...
            <div className="pointer-events-none absolute inset-0">
              ...
              <div className="aurora-blob-2 absolute -bottom-16 -left-16 h-56 w-56 rounded-full bg-[#7C3AED]/15 blur-[80px]" />
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-5 max-w-md text-base text-slate-400 leading-relaxed">
      ...
      {/* ══════════════════════════════════════════════
          8. FOOTER
      ══════════════════════════════════════════════ */}
      <footer className="relative z-10 border-t border-white/[0.06] bg-black" role="contentinfo">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 py-8 md:flex-row">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold text-slate-200">FrictionLens</span>
          </div>
